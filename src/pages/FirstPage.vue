<template>
	...
	s12.625-8.375,12.625-8.375s2.25-3.875,7.25,0.375s7.625,9.75,14.375,8.125C114.739,126.01,115.412,125.902,116.223,125.064z" />
                <circle class="eye1" fill="#013E51" cx="86.238" cy="57.885" r="6.667" />
                <circle class="eye2" fill="#013E51" cx="40.072" cy="57.885" r="6.667" />
	...
	c7.636,0,15.336,1.684,22.887,5.004c26.766,11.771,29.011,39.047,29.027,39.251V121.405z" />
            ...
            <p class="shadowFrame"><svg version="1.1" class="shadow" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" x="61px" y="20px" width="122.436px" height="39.744px"
...
@keyframes lineeff51 {
    ...
    100% {
        border-right: 2px solid rgba(190, 221, 247, 0.8);
    }
}
